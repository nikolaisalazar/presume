...
export function ReviewRail({
  ...
  return (
    <section
      className={cn(
        'review-rail relative flex h-[52px] min-w-0 items-center gap-2 overflow-hidden rounded-[var(--radius-structural)] border bg-surface px-3 shadow-[var(--shadow-structural)]',
