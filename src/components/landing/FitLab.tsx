...
export function FitLab() {
  ...
  const measurementState = useMemo<MeasurementState>(() => {
    ...
    try {
      return {
        status: 'ready',
        measurement: measurePreparedFitLab(preparation, width),
      }
    } catch {
  ...
  return (
    ...
    >
      ...
      <div className="landing-fit-lab__workspace">
          ...
          <div className="landing-fit-lab__width-control">
            ...
            <ToggleGroup
              ...
              onValueChange={values => {
                ...
                if (isFitLabWidth(nextWidth)) setWidth(Number(nextWidth) as FitLabWidth)
              }}
              variant="outline"
              size="sm"
              spacing={0}
        ...
        <div className="landing-fit-lab__measurement" aria-live="polite">
          <div
