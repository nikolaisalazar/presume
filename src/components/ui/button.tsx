...
const reviewVariantClasses =
  "relative overflow-hidden border before:pointer-events-none before:absolute before:bottom-1 before:left-0 before:h-px before:w-[46%] before:-translate-x-[120%] before:bg-linear-to-r before:from-transparent before:via-review-ink before:to-transparent before:content-[''] data-[loading]:before:animate-[review-progress-sweep_1.4s_ease-in-out_infinite] motion-reduce:data-[loading]:before:left-1/2 motion-reduce:data-[loading]:before:translate-x-[-50%] motion-reduce:data-[loading]:before:animate-none"
