...
const image = fs.readFileSync(
  path.join(root, 'public/landing/resume-letter@2x.png')
).toString('base64')
...
*{box-sizing:border-box}html,body{margin:0;width:1200px;height:630px;overflow:hidden}body{background:#edf2f0;color:#17211e;font-family:Geist,"Helvetica Neue",system-ui,sans-serif;-webkit-font-smoothing:antialiased}.frame{position:relative;display:grid;grid-template-columns:500px 1fr;gap:62px;align-items:center;width:100%;height:100%;padding:54px 58px}.copy{align-self:center}.brand{display:flex;align-items:center;gap:10px;margin-bottom:72px;font-size:17px;font-weight:720;letter-spacing:-.025em}.mark{display:grid;place-items:center;width:36px;height:36px;border-radius:4px;background:#14796f;color:#f7fffd}.mark svg{width:19px;height:19px}.title{margin:0;max-width:480px;font-size:68px;font-weight:650;letter-spacing:-.057em;line-height:.91}.lede{margin:24px 0 0;max-width:440px;color:#56635e;font-size:17px;line-height:1.55}.stage{position:relative;height:630px;align-self:end;overflow:hidden}.stage img{position:absolute;inset:74px 0 auto auto;display:block;width:440px;height:auto;background:#fffefb}.edge{position:absolute;left:58px;right:58px;bottom:30px;height:1px;background:#9eafa9}
</style><main class="frame"><section class="copy"><div class="brand"><span class="mark"><svg viewBox="0 0 256 256" fill="currentColor"><path d="M248 92.68a15.86 15.86 0 0 0-4.69-11.31l-68.68-68.69a16 16 0 0 0-22.63 0l-28.43 28.43-58 21.77a16.06 16.06 0 0 0-10.22 12.35L32.11 214.68A8 8 0 0 0 40 224a8.4 8.4 0 0 0 1.32-.11l139.44-23.24a16 16 0 0 0 12.35-10.17l21.77-58L243.31 104A15.87 15.87 0 0 0 248 92.68Zm-69.87 92.19L63.32 204l47.37-47.37a28 28 0 1 0-11.32-11.32L52 192.7 71.13 77.86 126 57.29 198.7 130ZM112 132a12 12 0 1 1 12 12 12 12 0 0 1-12-12Zm96-15.32L139.31 48l24-24L232 92.68Z"/></svg></span><span>Presume</span></div><h1 class="title">Your resume should stay yours.</h1><p class="lede">Edit the finished Letter page directly. Keep constraints visible. Export a stable PDF.</p></section><figure class="stage"><img src="data:image/png;base64,${image}" width="1390" height="1799" alt=""></figure><div class="edge"></div></main>`
