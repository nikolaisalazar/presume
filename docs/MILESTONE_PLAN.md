...
- [T2-2 implementation handoff](remediation/T2_2_SESSION_HANDOFF.md) — reproduced session/history and storage failures, current contracts, independent review, validation, and remaining limitations.
