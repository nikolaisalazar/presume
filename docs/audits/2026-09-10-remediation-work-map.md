...
| T2: Document state and editing | 19 | Plain-text editing, accessible field semantics, reliable persistence and save status, tab conflict handling, structural undo, complete backup/restore. Owns F03, F04, F05, F07, F09; supplies undo for F01 | T2-1 complete backups implemented on its branch; document-session work starts at T2-2 |
...
and integrate [T2-1](../remediation/T2_1_BACKUP_HANDOFF.md), then continue at T2-2.
