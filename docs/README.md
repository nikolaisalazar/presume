...
- [Approved Landing Brief](landing/PRESUME_LANDING_BRIEF.md): locked landing direction, final copy, visual and responsive contracts, evidence policy, and implementation acceptance criteria. The accompanying [production capture manifest](landing/PRODUCTION_CAPTURE_MANIFEST.md) records the native evidence assets and checksums.
